...
lift_definition inf_fset2 :: "'a fset \<Rightarrow> 'a set \<Rightarrow> 'a fset" is inter parametric inter_transfer (* mhahn *)
  by simp
...
lift_definition ffSigma :: "'a fset \<Rightarrow> ('a \<Rightarrow> 'b fset) \<Rightarrow> ('a \<times> 'b) fset" is Product_Type.Sigma by auto (* mhahn *)

abbreviation (* mhahn *)
  fTimes :: "'a fset \<Rightarrow> 'b fset \<Rightarrow> ('a \<times> 'b) fset"  (infixr "|\<times>|" 80) where
  "A |\<times>| B == ffSigma A (%_. B)"

abbreviation ffUnionAbb :: "'a fset fset \<Rightarrow> 'a fset"  ("\<Union>|" 1000) (* mhahn *)
  where "(\<Union>| x) \<equiv> ffUnion x"
...
lemmas ffUnionMono[simp] = Complete_Lattices.Union_mono[Transfer.transferred](* mhahn *)

lemmas ffUnion_iff [simp] = Complete_Lattices.Union_iff[Transfer.transferred](* mhahn *)

lemmas ffUnionI [intro] = Complete_Lattices.UnionI[Transfer.transferred](* mhahn *)

lemmas ffUnionE [elim!] = Complete_Lattices.UnionE[Transfer.transferred](* mhahn *)

lemmas ffUnion_upper = Complete_Lattices.Union_upper[Transfer.transferred](* mhahn *)

lemmas ffUnion_least = Complete_Lattices.Union_least[Transfer.transferred](* mhahn *)

lemmas ffUnion_empty = Complete_Lattices.Union_empty[Transfer.transferred](* mhahn *)

lemmas ffUnion_UNIV = Complete_Lattices.Union_UNIV[Transfer.transferred](* mhahn *)
lemmas ffUnion_insert = Complete_Lattices.Union_insert[Transfer.transferred](* mhahn *)
lemmas ffUnion_Un_distrib [simp] = Complete_Lattices.Union_Un_distrib[Transfer.transferred](* mhahn *)
lemmas ffUnion_Int_subset = Complete_Lattices.Union_Int_subset[Transfer.transferred](* mhahn *)
lemmas ffUnion_empty_conv = Complete_Lattices.Union_empty_conv[Transfer.transferred](* mhahn *)
lemmas ffempty_Union_conv = Complete_Lattices.empty_Union_conv[Transfer.transferred](* mhahn *)
lemmas ffsubset_Pow_Union = Complete_Lattices.subset_Pow_Union[Transfer.transferred](* mhahn *)
lemmas ffUnion_Pow_eq [simp] = Complete_Lattices.Union_Pow_eq[Transfer.transferred](* mhahn *)
lemmas ffUnion_mono = Complete_Lattices.Union_mono[Transfer.transferred](* mhahn *)
  ...
  lemmas ffSigmaD1 = Product_Type.SigmaD1[Transfer.transferred](* mhahn *)
lemmas ffSigmaD2 = Product_Type.SigmaD2[Transfer.transferred](* mhahn *)
lemmas ffSigmaE2 = Product_Type.SigmaE2[Transfer.transferred](* mhahn *)
lemmas ffSigma_cong = Product_Type.Sigma_cong[Transfer.transferred](* mhahn *)
lemmas ffSigma_mono = Product_Type.Sigma_mono[Transfer.transferred](* mhahn *)
lemmas ffSigma_empty1 [simp] = Product_Type.Sigma_empty1[Transfer.transferred](* mhahn *)
lemmas ffSigma_empty2 [simp] = Product_Type.Sigma_empty2[Transfer.transferred](* mhahn *)
lemmas ffmem_Sigma_iff[iff] = Product_Type.mem_Sigma_iff[Transfer.transferred](* mhahn *)
lemmas ffSigmaI[intro!] = Product_Type.SigmaI[Transfer.transferred](* mhahn *)
lemmas ffSigmaE[elim!] = Product_Type.SigmaE[Transfer.transferred](* mhahn *)

  
lemma ffmem_Times_iff: "x |\<in>| A |\<times>| B \<longleftrightarrow> fst x |\<in>| A \<and> snd x |\<in>| B" by (induct x) simp (* mhahn *)
